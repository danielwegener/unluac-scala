...
class LENode(val left: Int, val right: Int, val inverted: Boolean, line: Int, begin: Int, end: Int) extends Branch(line, begin, end) {

  def invert: Branch = {
    new LENode(left, right, !inverted, line, end, begin)
  }
